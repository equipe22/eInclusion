...
ALTER TABLE "user_aliases" ADD FOREIGN KEY ("user_id") REFERENCES "userapp" ("user_id");

ALTER TABLE "userprovider" ADD FOREIGN KEY ("user_id") REFERENCES "userapp" ("user_id");
